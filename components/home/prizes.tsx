      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-10 divide-y divide-border border-y border-border">
          {placements.map((placement) => (
            ...
            >
              <span className="font-mono text-xs text-muted-foreground tnum transition-colors duration-300 group-hover:text-accent">
                {placement.rank}
              </span>
              <span className="font-heading text-xl font-bold tnum sm:text-2xl">
                {placement.name}
              </span>
