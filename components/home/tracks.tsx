    ...
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            >
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <track.Icon
                    className="size-5 text-muted-foreground transition-all duration-300 group-hover:scale-110 group-hover:text-accent"
                    stroke={1.5}
                  />
                </div>
        ...
        <div className="mt-8 border-t border-border pt-4 font-mono text-xs text-muted-foreground">
          ...
          <p className="mt-1">
            judge: vjudge · icpc-style scoring · open to any BU department
          </p>
        </div>
      </div>
    </section>
