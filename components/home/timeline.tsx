        ...
        <ol className="mt-10 border-l border-border">
          {events.map((event) => (
            ...
            >
              <span
                aria-hidden="true"
                className="tnum absolute top-7 -left-4 bg-background px-1 font-mono text-xs text-muted-foreground transition-colors duration-300 group-hover:text-accent sm:-left-5"
              >
                {event.index}
              </span>
