...
import { IconCode, IconTerminal2, IconShield, IconCpu } from "@tabler/icons-react"
    ...
    <main className="relative min-h-screen overflow-hidden selection:bg-primary/30">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-6 py-24">
        <div className="mb-16 space-y-4 text-center">
          ...
          >
            <span className="text-sm font-medium tracking-wide text-primary uppercase font-mono">
              Behind the Scenes
            </span>
          </motion.div>
          <motion.h1 
            ...
            className="bg-gradient-to-r from-foreground via-foreground to-foreground/60 bg-clip-text pb-2 text-5xl font-bold tracking-tight text-transparent md:text-6xl font-heading"
          >
          ...
          <motion.p 
            ...
            className="mx-auto max-w-2xl text-lg text-muted-foreground font-mono"
          >
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {organizers.map((member, i) => (
            <motion.div
              ...
              className="group relative flex flex-col items-center rounded-2xl border border-border/50 bg-card/30 p-8 backdrop-blur-md transition-all hover:-translate-y-2 hover:border-primary/50 hover:bg-card/50 hover:shadow-[0_0_30px_rgba(var(--primary),0.1)] text-center"
            >
